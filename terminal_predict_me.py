...
def strage_combined_link_org_loc(tokens, tags):
    ...
    JF, YF, GJ, HM, DD, ZW, XZ = eval.get_result(tokens, tags)
    print_output(JF, 'JF')
    print_output(YF, 'YF')
    print_output(GJ, 'GJ')
    print_output(HM, 'HM')
...
class Result(object):
    ...
    def get_result(self, tokens, tags, config=None):
        ...
        return self.JF, self.YF, self.GJ, self.HM, self.DD, self.ZW, self.XZ
    ...
    def append(self, word, start, end, tag):
        if tag == 'JF':
            self.JF.append(Pair(word, start, end, 'JF'))
        elif tag == 'YF':
            self.YF.append(Pair(word, start, end, 'YF'))
        elif tag == 'GJ':
            self.GJ.append(Pair(word, start, end, 'GJ'))
        elif tag == 'HM':
            self.GJ.append(Pair(word, start, end, 'HM'))
        elif tag == 'DD':
            self.DD.append(Pair(word, start, end, 'DD'))
        elif tag == 'ZW':
            self.DD.append(Pair(word, start, end, 'ZW'))
        elif tag == 'XZ':
            self.GJ.append(Pair(word, start, end, 'XZ'))
        else:
